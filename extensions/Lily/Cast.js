...
/* generated l10n code */Scratch.translate.setup({"de":{"_Cast":"Typen"},"fi":{"_Cast":"Muunna","_boolean":"totuusarvoksi","_cast [INPUT] to [TYPE]":"muunna [INPUT] [TYPE] ","_default":"oletusarvoiseksi","_number":"numeroksi","_string":"merkkijonoksi","_type of [INPUT]":"kohteen [INPUT] tyyppi"},"it":{"_Cast":"Conversione","_string":"stringa"},"ja":{"_Cast":"型変換","_boolean":"真理値","_cast [INPUT] to [TYPE]":"[INPUT]を[TYPE]に変換する","_default":"黙認","_number":"数字","_string":"文字列","_type of [INPUT]":"[INPUT]の型"},"ko":{"_Cast":"캐스팅","_boolean":"불리언","_cast [INPUT] to [TYPE]":"[INPUT]을(를) [TYPE]화 하기","_default":"기본","_number":"숫자","_string":"문자열","_type of [INPUT]":"[INPUT]의 타입"},"nb":{"_Cast":"Kast"},"nl":{"_Cast":"Omzetten","_boolean":"booleaans","_cast [INPUT] to [TYPE]":"zet [INPUT] om naar [TYPE]","_default":"standaard","_number":"getal","_type of [INPUT]":"soort van [INPUT]"},"pl":{"_number":"liczba"},"ru":{"_Cast":"Каст","_boolean":"логическое","_cast [INPUT] to [TYPE]":"вывести [INPUT] в [TYPE]","_default":"по умолчанию","_number":"цифра","_string":"строка","_type of [INPUT]":"тип переменной [INPUT]"},"uk":{"_Cast":"Типи","_number":"число"},"zh-cn":{"_Cast":"类型转换","_boolean":"布尔值","_cast [INPUT] to [TYPE]":"将[INPUT]转换为类型[TYPE]","_default":"默认类型","_number":"数字","_string":"字符串","_type of [INPUT]":"[INPUT]的类型"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
